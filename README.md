...
As data scientists, we can provide solutions to the healthcare sector for optimizing resources and reducing 
...
The motivation of choosing this study is to apply data analytics, specifically statistical analytical tools to identify 
...
Appendix A of the report presents the data dictionary for the variables in the dataset. Information was 
